...
type SvgIconProps = React.ComponentPropsWithoutRef<"svg">;
type ColorPanelsIcon = React.ComponentType<SvgIconProps>;
...
const defaultDesktopShaderProps: Partial<ColorPanelsProps> = {
  width: 1280,
  height: 720,
  colors: ["#D4FF00", "#A8E600", "#3F4A00", "#F0FF99"],
  colorBack: "#ffffff00",
  density: 5.03,
  angle1: 0.68,
  angle2: 0.28,
...
export function AISDKIcon(props: SvgIconProps) {
  return (
    <svg
      color="currentcolor"
...
export function NextjsIcon(props: SvgIconProps) {
